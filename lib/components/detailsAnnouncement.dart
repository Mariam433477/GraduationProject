...
Widget containersOfAnnouncement(String Text,var icon, Color color, Color iconColor ,
    Color TextColor,press,var child){
  return
    GestureDetector(
      onTap: press,
      child: Container(
  ...
  return Row(
    ...
    children: [
      Padding(
          ...
          child: FaIcon(FontAwesomeIcons.solidCircle,color:Color(0xffF23B5F) ,size: 10,)
      ),
      Padding(
