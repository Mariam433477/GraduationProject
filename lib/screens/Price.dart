          ...
          Center(
              child: Column(children: [
                ...
                containersOfAnnouncement('Price', FontAwesomeIcons.dollarSign,
                    Color(0xffF23B5F), Colors.white, Colors.white, () {},SizedBox(width:0)),
                SizedBox(
                  height: 10,
                ),
                containersOfAnnouncement(
                ...
                Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Txt('Price', Color(0xff25334D), 15,
                          FontWeight.normal),
                    ),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    Padding(
                      padding: const EdgeInsets.only(left: 30, bottom: 15),
                      child: Txt('Space type', Color(0xff25334D), 15,
                          FontWeight.normal),
                    ),
                  ],
                ),
