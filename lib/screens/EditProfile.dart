  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        ...
        elevation:
        0,leading:
      GestureDetector(child: Icon(Icons.arrow_back,size: 30,color:Color(0xffF23B5F)),
        onTap:(){
          Get.back();
        } ,), actions: [
         ...
         crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Padding(
              ...
              child: Txt('Edit Profile', Color(0xff25334D), 20, FontWeight.bold),
            ),
            SizedBox(height: 200,
              child: Row(
            ...
            Center(
              child: Column(
                children: [
                  Inputunderline(authController.fullname, 'Full Name', false, TextInputType.text, IconButton(onPressed:(){},
