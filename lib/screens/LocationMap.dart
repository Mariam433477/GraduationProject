    ...
    return Scaffold(
      ...
      body: Stack(children: [
        ...
        Positioned(left: 10,bottom: 30,
            child: read?const SizedBox(height: 0,width: 0):
            SizedBox(height: 38,child:MainBtn(Txt("save".tr, Colors.black, 20, FontWeight.w500), 80, 40, 15,
                save?yellowColor:yellowColor.withOpacity(0.5), save?yellowColor:yellowColor.withOpacity(0.5),(){
                  if(save){
                    // mapLat.value=lat;
                    // mapLong.value=long;
                    // action();
        ...
        Positioned(
          right: width*0.55,
          bottom:10,
          child: MainBtn(Txt('Previous Step',Color(0xffF23B5F),20,FontWeight.normal),width*0.4,
              height*0.05,5,Colors.white, Colors.white,(){
                Get.back();
              }),
        ),
      ],
